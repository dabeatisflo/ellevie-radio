...
type Tab = 'direct' | 'programmes' | 'animatrices';
      ...
      {showPrivacy && (
        <View style={styles.privacyCard}>
          ...
          <Text style={styles.privacyText}>
            L’application ellevie Radio ne demande aucun compte et ne stocke aucune donnée
            personnelle. Pour diffuser le direct, elle se connecte au service de streaming Zeno
            Media, qui peut recevoir des données techniques comme l’adresse IP et l’heure de
            connexion selon sa propre politique.
          </Text>
          <Text style={styles.privacyText}>
            L’application n’utilise ni publicité personnalisée, ni géolocalisation, ni microphone,
            ni carnet d’adresses. Pour toute question : contact@ellevie.fr.
          </Text>
          <Pressable
            accessibilityRole="link"
